...
- If a specialist tool reports that information is not in the database or documentation (e.g. loyalty/rewards programs), tell the customer that feature or program is not available; never invent policies, enrollment steps, contacts, or teams for it.
